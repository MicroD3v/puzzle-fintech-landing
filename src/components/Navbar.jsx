...
export default function Navbar({ darkMode, setDarkMode }) {
  ...
  return (
   ...
   <motion.nav
    ...
    className="fixed top-0 left-0 w-full z-50 border-b border-black/[0.05] dark:border-white/[0.06] bg-white/40 dark:bg-darkBg/40 backdrop-blur-xl transition-colors duration-300"
   >
