    ...
    >
      ...
      <div className="flex items-center justify-center gap-4 mb-16 select-none">
        ...
        <button
          ...
          className="relative w-14 h-7 bg-white/10 dark:bg-darkCard border border-black/[0.06] dark:border-white/[0.08] rounded-full p-1 flex items-center cursor-none transition-colors"
        >
          <motion.div
            layout
            className="w-5 h-5 bg-accentViolet rounded-full shadow-md shadow-accentViolet/30"
        ...
        <span
          className={`text-sm font-medium flex items-center gap-1.5 transition-colors duration-200 ${billingCycle === "yearly" ? "text-white" : "text-gray-500"}`}
        >
          Yearly
